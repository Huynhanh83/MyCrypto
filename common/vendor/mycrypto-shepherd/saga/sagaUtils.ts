...
export const createRetryCall = (currentCall: ProviderCallWithPid): IProviderCall => {
...
export const makeProviderStats = (timer: any, isOffline: boolean): IProviderStats => ({
...
export const makeRetVal = (error: Error | null = null, result: string | null = null) => ({
  result,
  error
});
