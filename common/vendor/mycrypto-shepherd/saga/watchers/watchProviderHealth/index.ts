...
import {
  ...
  PROVIDER_STATS,
  providerOnline
} from '../../../ducks/providerBalancer/providerStats';
import { call, put, race, take, takeEvery } from 'redux-saga/effects';
import { pollProviderUntilConnected, waitForProviderStatsToExist } from './helpers';

function* watchOfflineProvider({ payload: { providerId } }: IProviderStatsOffline) {
...
export const providerHealthWatcher = [takeEvery(PROVIDER_STATS.OFFLINE, handleWatching)];
