import {
  ...
  setManualFailed,
  setManualSucceeded
} from '../../ducks/providerBalancer/balancerConfig';
...
function* attemptManualMode(providerId: string, skipOfflineCheck: boolean): SagaIterator {
...
export const manualModeWatcher = [takeEvery(BALANCER.MANUAL_REQUESTED, handleManualMode)];
