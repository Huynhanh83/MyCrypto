...
export const getBalancerConfig = (state: RootState) => getProviderBalancer(state).balancerConfig;

export const getQueueTimeout = (state: RootState) => getBalancerConfig(state).queueTimeout;

export const getManualMode = (state: RootState) => getBalancerConfig(state).manual;

export const isOffline = (state: RootState) => getBalancerConfig(state).offline;

export const getNetwork = (state: RootState) => getBalancerConfig(state).network;
