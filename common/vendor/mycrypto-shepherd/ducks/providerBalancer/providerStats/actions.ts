...
export const providerOnline = (payload: IProviderStatsOnline['payload']): IProviderStatsOnline => ({
...
export const providerAdded = (payload: IProviderStatsAdded['payload']): IProviderStatsAdded => ({
