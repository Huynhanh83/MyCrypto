...
const handleProviderConfigAdd: PCReducer = (state, { payload }: IAddProviderConfig) => {
  if (state[payload.id]) {
...
const handleProviderConfigChange: PCReducer = (state, { payload }: IChangeProviderConfig) => {
...
const handleProviderConfigRemove: PCReducer = (state, { payload }: IRemoveProviderConfig) => {
  if (!state[payload.id]) {
