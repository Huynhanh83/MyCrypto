...
export const getProviderConfigs = (state: RootState) => getRootState(state).providerConfigs;
...
export const getProviderInstAndTimeoutThreshold = (state: RootState, id: string) => {
