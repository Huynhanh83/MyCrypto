...
export class RPCRequests {
  ...
  public estimateGas(transaction: Partial<IHexStrTransaction>): IEstimateGasRequest | any {
    return {
  ...
  public getTransactionCount(address: string): IGetTransactionCountRequest | any {
    return {
  ...
  public getTransactionByHash(txhash: string): IGetTransactionByHashRequest | any {
    return {
  ...
  public getTransactionReceipt(txhash: string): IGetTransactionReceiptRequest | any {
    return {
